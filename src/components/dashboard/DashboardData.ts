...
export const depositPlans = [
  {
    level: 1, name: 'Foundation', price: '$5', icon: BookOpen,
    subtitle: 'Core skills with a clean premium starter experience.',
    bubbles: [{ icon: Cpu, text: '+25 AI Credits' }, { icon: Zap, text: '25K AI Tokens' }],
  ...
  {
    level: 2, name: 'Pro Builder', price: '$10', icon: Code2,
    subtitle: 'Sharper workflow, cleaner execution, more control.',
    bubbles: [{ icon: Cpu, text: '50 AI Credits' }, { icon: Zap, text: '80K AI Tokens' }],
  ...
  {
    level: 3, name: 'Cyber Elite', price: '$20', icon: Shield,
    subtitle: 'A stronger, sharper tier with executive energy.',
    bubbles: [{ icon: Cpu, text: '100 AI Credits' }, { icon: Zap, text: '120K AI Tokens' }, { icon: Wand2, text: 'Adv. Tools' }],
  ...
  {
    level: 4, name: 'AI Mastery', price: '$40', icon: Brain,
    subtitle: 'Luxury-grade visual treatment with an AI-first identity.',
    bubbles: [{ icon: Cpu, text: '250 AI Credits' }, { icon: Zap, text: '300K AI Tokens' }, { icon: Headphones, text: 'Priority Support' }, { icon: FileCode, text: 'Daily Src + Dev Guide' }],
  ...
  {
    level: 5, name: 'Quantum Leader', price: '$80', icon: Crown,
    subtitle: 'Elite leadership tier with advanced cloud & DevOps mastery.',
    bubbles: [{ icon: Cpu, text: '500 AI Credits' }, { icon: Zap, text: '500K AI Tokens' }, { icon: Headphones, text: 'VIP Support' }],
    features: ['Cloud Architecture', 'DevOps & CI/CD', 'System Design'],
    theme: { primary: '#f97316', secondary: '#ea580c', glow: 'rgba(249, 115, 22, 0.5)', bgGlow: 'rgba(249, 115, 22, 0.15)', text: '#ffedd5' },
  },
  {
    level: 6, name: 'Supreme Visionary', price: '$160', icon: Gem,
    subtitle: 'The ultimate tier — blockchain, quantum, and AGI mastery.',
    bubbles: [{ icon: Cpu, text: '1000 AI Credits' }, { icon: Zap, text: '1M AI Tokens' }, { icon: Headphones, text: 'Platinum Support' }, { icon: FileCode, text: 'Full Source Access' }],
    features: ['Blockchain & Web3', 'Quantum Computing', 'Advanced AI & AGI'],
