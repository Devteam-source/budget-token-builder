    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          <p className="text-primary font-bold tracking-widest text-[11px] uppercase">Menu</p>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col min-h-full">
            ...
            <div className="px-4 pb-3">
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                ...
                <a href="#" className="p-2 rounded-lg hover:bg-white/10 transition-colors">
                  <svg viewBox="0 0 24 24" className="w-5 h-5" style={{ fill: '#FFFC00' }}><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12.922-.214.04-.012.06-.012.1 0 .16.06.32.18.32.36 0 .12-.06.278-.18.399-.36.36-1.08.559-1.56.659-.075.018-.15.03-.198.045-.06.012-.15.048-.21.09-.06.06-.12.144-.12.24.015.18.06.36.12.54.24.54.72 1.08 1.38 1.559.42.3.9.54 1.32.66.12.045.24.075.24.12.06.09.029.24-.09.36-.36.3-.81.42-1.26.48-.21.03-.42.06-.6.09-.075.015-.15.045-.24.15-.075.09-.12.21-.15.315-.06.135-.21.585-.93.585-.12 0-.27-.03-.42-.06-.6-.15-1.2-.42-2.1-.42-.27 0-.54.015-.81.06-1.62.27-2.94 1.74-5.46 1.74h-.12c-2.52 0-3.84-1.47-5.46-1.74a5.89 5.89 0 00-.81-.06c-.9 0-1.5.27-2.1.42-.15.03-.3.06-.42.06-.72 0-.87-.45-.93-.585-.03-.105-.075-.225-.15-.315-.09-.105-.165-.135-.24-.15-.18-.03-.39-.06-.6-.09-.45-.06-.9-.18-1.26-.48-.12-.12-.15-.27-.09-.36 0-.045.12-.075.24-.12.42-.12.9-.36 1.32-.66.66-.48 1.14-1.02 1.38-1.559.06-.18.105-.36.12-.54 0-.096-.06-.18-.12-.24-.06-.042-.15-.078-.21-.09a3.07 3.07 0 01-.198-.045c-.48-.1-1.2-.3-1.56-.66-.12-.12-.18-.278-.18-.399 0-.18.16-.3.32-.36.04-.012.06-.012.1 0 .263.094.622.198.922.214.198 0 .326-.045.401-.09a8.167 8.167 0 01-.033-.57c-.104-1.628-.23-3.654.3-4.847C3.447 1.069 6.806.793 7.796.793h4.41z"/></svg>
                </a>
                {/* Instagram - official gradient (using magenta) #E4405F */}
                <a href="#" className="p-2 rounded-lg hover:bg-white/10 transition-colors">
                ...
                {/* TikTok - official black/white */}
                <a href="#" className="p-2 rounded-lg hover:bg-white/10 transition-colors">
                  <svg viewBox="0 0 24 24" className="w-5 h-5" style={{ fill: '#ffffff' }}><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
                </a>
              </div>
            </div>
            ...
            <div className="px-3 pb-6 pt-2 border-t border-border/30 mt-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-3 py-3 rounded-lg text-sm font-semibold text-destructive hover:bg-destructive/10 transition-all min-h-[44px] cursor-pointer relative z-[60]"
              >
